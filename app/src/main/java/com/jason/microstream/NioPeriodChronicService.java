...
//import com.jason.microstream.core.im.tup.Sender;
...
//        super.onCreate();
//        channelManager = new ChannelHolder();
//        sender = new Sender();
//    }
//
//    @Override
...
//    //step1
//    public boolean registerNioSelector() {
////        boolean ret = channelManager.registerNioSelector(mSocketChannel, selector);
////        if (ret) {
////            return true;
////        }
//        return false;
...
//                    try {
//                        selector.select();
//                        Iterator<SelectionKey> iterator = NioPeriodChronicService.this.selector.selectedKeys().iterator();
