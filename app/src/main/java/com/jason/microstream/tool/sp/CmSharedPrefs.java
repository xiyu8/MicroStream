...
public class CmSharedPrefs {

    private static CmSharedPrefs sInstance;
    private SharedPreferences mManager;

    private static final String SP_NAME = "micro_stream";

    private CmSharedPrefs() {
    }

    public static CmSharedPrefs getInstance() {
        if (sInstance == null) {
            sInstance = new CmSharedPrefs();
        }
        return sInstance;
    }
